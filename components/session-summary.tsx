  ...
  return (
    <div className="px-4 max-w-[600px] animate-[fade-in-up_0.3s_ease]">
      <div className="bg-bg-primary rounded-lg border border-stroke-default p-4">
        <div className="text-xs font-semibold text-text-secondary mb-2.5 uppercase tracking-wider">
          Session Summary &mdash; Auto-attached to WO #{SCENARIO.wo.number}
        </div>
        <div className="text-[13px] leading-5 text-text-primary">
          <strong>Steps attempted:</strong>{" "}
          {stepsAttempted.join(" \u2192 ")}
        </div>
        <div className="text-[13px] leading-5 text-text-primary mt-1">
